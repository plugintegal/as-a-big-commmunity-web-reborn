        ...
        return (
            <>
                <section className="container text-gray-600 body-font container mx-auto px-5 py-8">
                    <h1 className="text-4xl font-bold text-center mb-6 text-gray-700">Payment</h1>
                        ...
                        <div className="bg-gray-200 w-full sm:w-full md:w-1/2 lg:w-1/2 rounded-tr-none rounded-br-xl sm:rounded-tr-xl rounded-tl-none sm:rounded-tl-xl md:rounded-tl-none rounded-bl-xl sm:rounded-bl-xl md:rounded-bl-none  px-8 py-10 container mx-auto">
                            <div className="flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0 pl-0 sm:pl-6 md:pl-3 lg:pl-0 xl:pl-16 ">
                                <div className="relative mb-4">
                                    <label htmlFor="name" className="leading-7 text-sm text-gray-600">Nomor Rekening</label>
                                ...
                                <div className="relative mb-4">
                                    <label htmlFor="name" className="leading-7 text-sm text-gray-600">Nomor Whatsapp</label>
                                    <input type="text" id="name" name="name" className="w-full sm:w-80 md:w-64 lg:w-98 block bg-gray-200 rounded-full border border-gray-700 focus:border-gray-700 focus:ring-2 focus:ring-gray-700 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                                </div>
                                <p className="leading-relaxed font-bold text-gray-700 mt-6">Tata Cara Transfer</p>
                                <ol className="mb-10">
                                    <li>1. Transfer Ke nomor rekening diatas ini an / Kokoh Felix Yunianto Gunawan</li>
                                    <li>2. Hubingi Nomor whatsap yang tersedia diatas untuk mengkonfirmasi.</li>
                                    <li>3. Hubingi nmor whatsapp yang tersedia dengan format <br/>
                                        Nama: <br/>
                                        Nama Event: <br/>
                                        Sertakan Foto Bukti Transfer .</li>
                                    <li>4. Tunggu link event di email klaian</li>
                                </ol>
                                <button className="w-full sm:w-80 md:w-64 lg:w-98 text-white bg-blue-400 rounded-full border-0 py-2 px-6 focus:outline-nonetext-lg">back to Home</button>
                            </div>
                        </div>
                    </div>
                </section>
